      ...
      <div class="container">
        <div class="contact-grid">
          ...
          <div class="channels reveal">
            <h2 class="channels-title">Reach Out Directly</h2>

            <div class="channel-cards">
              <a href="mailto:manojlakmal999@gmail.com" class="channel-card card">
                ...
                <div class="channel-info">
                  ...
                  <span class="channel-value">manojlakmal999@gmail.com</span>
                </div>
                <svg class="channel-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2">
                  <path d="M5 12h14" />
              ...
              <a href="https://wa.me/94768104839" target="_blank" rel="noopener" class="channel-card card">
                ...
                <div class="channel-info">
                  ...
                  <span class="channel-value">+94 76 810 4839</span>
                </div>
                <svg class="channel-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2">
                  <path d="M5 12h14" />
              ...
              <a href="https://github.com/l4km47" target="_blank" rel="noopener" class="channel-card card">
                ...
                <div class="channel-info">
                  ...
                  <span class="channel-value">github.com/l4km47</span>
                </div>
                <svg class="channel-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2">
                  <path d="M5 12h14" />
            ...
            <!-- Availability -->
            <div class="availability-card card reveal reveal-delay-2">
          ...
          <!-- Quick Email Form -->
          <div class="email-form-wrap reveal reveal-delay-1">
            <div class="form-card card-glass">
              <h2>Send a Message</h2>
              <p class="form-note">This will open your email client with the details pre-filled.</p>
