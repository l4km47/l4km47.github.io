    ...
    <Transition name="mobile-menu">
      <div v-if="menuOpen" class="mobile-menu">
        ...
        <div class="mobile-actions">
          <a href="https://github.com/l4km47" target="_blank" rel="noopener" class="btn btn-outline w-full" style="justify-content:center">
            GitHub Profile
          </a>
          <RouterLink to="/contact" class="btn btn-primary w-full" style="justify-content:center" @click="menuOpen = false">
            Hire Me
          </RouterLink>
        </div>
      </div>
...
.logo-bracket { color: var(--color-primary-light); }
.logo-name {
...
.nav-link.active { color: var(--color-primary-light); background: rgba(124,58,237,0.1); }
...
.mobile-link:hover { color: var(--color-text); background: var(--color-surface); }
