<template>
  <RouterLink :to="`/projects/${project.slug}`" class="project-card card">
    ...
    <div class="card-thumb">
      <img v-if="thumbnail && !imgError" :src="thumbnail" :alt="`${project.title} screenshot`"
        @error="imgError = true" loading="lazy" referrerpolicy="no-referrer" />
      <div v-else class="thumb-placeholder"
        :style="{ background: `linear-gradient(135deg, ${accent}22 0%, ${accent}11 100%)` }">
        <div class="thumb-icon" :style="{ color: accent }">
    ...
    <div class="card-body">
      ...
      <div class="card-links">
        ...
        <div class="ext-links">
          <a v-if="githubUrl" :href="githubUrl" target="_blank" rel="noopener noreferrer" @click.stop title="GitHub"
            class="ext-link">
          ...
          <a v-if="demoUrl" :href="demoUrl" target="_blank" rel="noopener noreferrer" @click.stop title="Live Demo"
            class="ext-link">
...
const thumbnail = computed(() => safeAssetUrl(props.project.thumbnail))
const accent = computed(() => safeColor(props.project.color))
